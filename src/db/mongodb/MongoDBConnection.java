	...
	public void saveItem(Item item) {
		...
		if (iterable.first() == null) {
			db.getCollection("items").insertOne(new Document().append("item_id",item.getItemId())
				.append("name", item.getName()).append("distance", item.getDistance()).append("address", item.getAddress())
				.append("url", item.getUrl()).append("rating", item.getRating()).append("categories", item.getCategories())
